                ...
                <div class="video-feed-item">
                    ...
                    <div class="pc-action-bar item-action-bar vertical">
                        <div class="bar-item-wrapper">
                            <div class="jsx-1809469258 bar-item-img engagement-icon-v23">
                                <svg id="like-button" @click="likeFunction" class="button" width="24" height="24" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.66022 8.55074C11.4597 3.71786 19.0168 3.74482 24 9.08441C28.9832 3.74482 36.5403 3.71786 41.3398 8.55074C46.2201 13.465 46.2201 21.4262 41.3398 26.3404L25.3553 42.436C24.9969 42.797 24.509 43 24 43C23.491 43 23.0031 42.797 22.6447 42.436L6.66022 26.3404C1.77993 21.4262 1.77993 13.465 6.66022 8.55074Z"></path></svg>
                            </div>
                        </div>
                        <p class="bar-item-text engagement-text-v23 jsx-961836452" title="like">{{likes}}</p>
                    </div>
                    ...
                    <div class="pc-action-bar item-action-bar vertical">
                        ...
                        <p class="bar-item-text engagement-text-v23 jsx-961836452" title="like">8</p>
                    </div>
                    <div class="pc-action-bar item-action-bar">
                        <div class="bar-item-wrapper">
                            <div class="jsx-1809469258 bar-item-img engagement-icon-v23">
                        ...
                        <p class="bar-item-text engagement-text-v23 jsx-961836452" title="like">1</p>
                    </div>
                </div>
            </div>
        </div>
